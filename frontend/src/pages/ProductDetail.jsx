  ...
  return productData ? (
    <div>
      ...
      <div className="w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col  overflow-x-hidden">
        {/* Tabs */}
        <div className="flex px-[20px] mt-[40px] md:mt-[60px] lg:mt-[80px] lg:ml-[80px] ml-[0px]">
          <button
            className={`border px-5 py-3 text-sm ${
              activeTab === "description" ? "bg-white text-black" : "text-white"
            }`}
          ...
          <button
            className={`border px-5 py-3 text-sm ${
              activeTab === "reviews" ? "bg-white text-black" : "text-white"
            }`}
        ...
        <div className="w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px] flex items-center justify-center">
          {activeTab === "description" ? (
            ...
            <p className="w-[95%] h-[90%] flex items-center justify-center">
              ⭐⭐⭐⭐☆ (4.5/5) – Based on 124 reviews <br />
              Customers love the comfort, fit, and quality of this shirt.
